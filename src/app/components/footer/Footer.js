                ...
                <div className={styles.brandLogo}>
                  ...
                  >
                    ...
                    <path
                      ...
                      fill="#E51236"
                    />
                  <title id="svgTitle">YRGO logo</title>
                  </svg>
                </div>
                <p className={styles.brandDescription}>
                  För dig som vill skaffa dig ett yrke. För dig som vill byta
                  yrke och för dig som vill fördjupa dig i ett yrke.
                </p>
                <button
                  className={styles.brandLink}
                  onClick={() => (window.location.href = "https://www.yrgo.se")}
                >
                  Gå till yrgo.se
                </button>
